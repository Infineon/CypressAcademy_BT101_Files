...
{
    .device_name                         = (uint8_t*)cy_bt_device_name,                               /**< Local device name (NULL terminated) */
    ...
    .ble_scan_cfg =                                                 /* BLE scan settings  */
    {
        ...
        .high_duty_scan_interval         = CY_BT_HIGH_DUTY_SCAN_INTERVAL,                             /**< High duty scan interval */
        .high_duty_scan_window           = CY_BT_HIGH_DUTY_SCAN_WINDOW,                               /**< High duty scan window */
        ...
        .high_duty_conn_scan_interval    = CY_BT_HIGH_DUTY_CONN_SCAN_INTERVAL,                        /**< High duty cycle connection scan interval */
        .high_duty_conn_scan_window      = CY_BT_HIGH_DUTY_CONN_SCAN_WINDOW,                          /**< High duty cycle connection scan window */
        .high_duty_conn_duration         = CY_BT_HIGH_DUTY_CONN_SCAN_DURATION,                        /**< High duty cycle connection duration in seconds (0 for infinite) */

        .low_duty_conn_scan_interval     = CY_BT_LOW_DUTY_CONN_SCAN_INTERVAL,                         /**< Low duty cycle connection scan interval */
        .low_duty_conn_scan_window       = CY_BT_LOW_DUTY_CONN_SCAN_WINDOW,                           /**< Low duty cycle connection scan window */
        ...
        .conn_min_interval               = CY_BT_CONN_MIN_INTERVAL,                                   /**< Minimum connection interval */
        .conn_max_interval               = CY_BT_CONN_MAX_INTERVAL,                                   /**< Maximum connection interval */
        .conn_latency                    = CY_BT_CONN_LATENCY,                                        /**< Connection latency */
        .conn_supervision_timeout        = CY_BT_CONN_SUPERVISION_TIMEOUT,                            /**< Connection link supervision timeout */
    },
    ...
    .ble_advert_cfg =                                               /* BLE advertisement settings */
    {
        ...
        .high_duty_min_interval          = CY_BT_HIGH_DUTY_ADV_MIN_INTERVAL,                          /**< High duty undirected connectable minimum advertising interval */
        .high_duty_max_interval          = CY_BT_HIGH_DUTY_ADV_MAX_INTERVAL,                          /**< High duty undirected connectable maximum advertising interval */
        ...
        .low_duty_min_interval           = CY_BT_LOW_DUTY_ADV_MIN_INTERVAL,                           /**< Low duty undirected connectable minimum advertising interval */
        .low_duty_max_interval           = CY_BT_LOW_DUTY_ADV_MAX_INTERVAL,                           /**< Low duty undirected connectable maximum advertising interval */
        ...
        .high_duty_directed_min_interval = CY_BT_HIGH_DUTY_DIRECTED_ADV_MIN_INTERVAL,                 /**< High duty directed connectable minimum advertising interval */
        .high_duty_directed_max_interval = CY_BT_HIGH_DUTY_DIRECTED_ADV_MAX_INTERVAL,                 /**< High duty directed connectable maximum advertising interval */

        .low_duty_directed_min_interval  = CY_BT_LOW_DUTY_DIRECTED_ADV_MIN_INTERVAL,                  /**< Low duty directed connectable minimum advertising interval */
        .low_duty_directed_max_interval  = CY_BT_LOW_DUTY_DIRECTED_ADV_MAX_INTERVAL,                  /**< Low duty directed connectable maximum advertising interval */
        ...
        .high_duty_nonconn_min_interval  = CY_BT_HIGH_DUTY_NONCONN_ADV_MIN_INTERVAL,                  /**< High duty non-connectable minimum advertising interval */
        .high_duty_nonconn_max_interval  = CY_BT_HIGH_DUTY_NONCONN_ADV_MAX_INTERVAL,                  /**< High duty non-connectable maximum advertising interval */
        ...
        .low_duty_nonconn_min_interval   = CY_BT_LOW_DUTY_NONCONN_ADV_MIN_INTERVAL,                   /**< Low duty non-connectable minimum advertising interval */
        .low_duty_nonconn_max_interval   = CY_BT_LOW_DUTY_NONCONN_ADV_MAX_INTERVAL,                   /**< Low duty non-connectable maximum advertising interval */
    ...
    .l2cap_application =                                            /* Application managed l2cap protocol configuration */
    {
        ...
        .max_rx_mtu                     = CY_BT_L2CAP_MTU_SIZE
    },
