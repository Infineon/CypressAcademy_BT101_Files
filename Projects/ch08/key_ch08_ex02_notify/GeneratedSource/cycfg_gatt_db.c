...
const uint8_t gatt_database[] = 
{
    ...
    PRIMARY_SERVICE_UUID128 (HDLS_BT101, __UUID_SERVICE_BT101),
        ...
        CHARACTERISTIC_UUID128 (HDLC_BT101_COUNTER, HDLC_BT101_COUNTER_VALUE, __UUID_CHARACTERISTIC_BT101_COUNTER, GATTDB_CHAR_PROP_READ | GATTDB_CHAR_PROP_NOTIFY, GATTDB_PERM_READABLE),
            /* Descriptor: Client Characteristic Configuration */
            CHAR_DESCRIPTOR_UUID16_WRITABLE (HDLD_BT101_COUNTER_CLIENT_CHAR_CONFIG, __UUID_DESCRIPTOR_CLIENT_CHARACTERISTIC_CONFIGURATION, GATTDB_PERM_READABLE | GATTDB_PERM_WRITE_REQ),
};
