...
const uint8_t gatt_database[] = 
{
    ...
    PRIMARY_SERVICE_UUID128 (HDLS_MODUSLED, __UUID_SERVICE_MODUSLED),
        /* Characteristic: LED */
        CHARACTERISTIC_UUID128_WRITABLE (HDLC_MODUSLED_LED, HDLC_MODUSLED_LED_VALUE, __UUID_CHARACTERISTIC_MODUSLED_LED, LEGATTDB_CHAR_PROP_READ | LEGATTDB_CHAR_PROP_WRITE, LEGATTDB_PERM_READABLE | LEGATTDB_PERM_WRITE_REQ),
};
...
const uint16_t app_modusled_led_len = (sizeof(app_modusled_led));
