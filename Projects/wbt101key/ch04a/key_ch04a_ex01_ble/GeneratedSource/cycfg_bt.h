                ...
                <ProfileRole type="Server">
                    ...
                    <Services>
                        <Service type="org.bluetooth.service.generic_access">
                            <ServiceProperties>
                                <Property id="EntityID" value="{e0096b5f-1095-43a6-8783-6b4689616a2a}"/>
                                    ...
                                    <Fields>
                                        <Field>
                                            <FieldProperties>
                                                ...
                                                <Property id="Value" value="key_LED"/>
                        ...
                        <Service type="org.bluetooth.service.generic_attribute">
                            <ServiceProperties>
                                <Property id="EntityID" value="{2c1fcff3-cf95-4aa6-8f25-1fdda18413c3}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics/>
                        </Service>
                        <Service type="org.bluetooth.service.custom">
                            <ServiceProperties>
                                <Property id="EntityID" value="{1eab80e0-08e6-4715-ae50-1d1588431d8f}"/>
                                <Property id="DisplayName" value="ModusLED"/>
                                <Property id="UUID" value="34B3B388-54B4-4526-AF50-A664D1A84A5D"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics>
                                <Characteristic type="org.bluetooth.characteristic.custom">
                                    <CharacteristicProperties>
                                        ...
                                        <Property id="UUID" value="E0677AE2-AF1C-4AD2-9898-5B55F7CE72A8"/>
                                    </CharacteristicProperties>
                                    <Fields>
                                        <Field>
                                            <FieldProperties>
