 ...
 * Function Prototypes
 ******************************************************************/
static void                  advscanner_change_scan_state      (wiced_bt_ble_scan_type_t new_state);
...
wiced_bt_dev_status_t advscanner_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENABLED_EVT:
        ...
        if (WICED_BT_SUCCESS == p_event_data->enabled.status)
        {
            ...
            advscanner_change_scan_state(BTM_BLE_SCAN_TYPE_HIGH_DUTY);
        }
...
void rx_cback( void *data )
{
    ...
    {
        /* Turn scanning off */
        advscanner_change_scan_state(BTM_BLE_SCAN_TYPE_NONE);
    }
    else if( readbyte == 't' )
    {
        /* Dump table */
        wiced_hal_puart_print( "\n\r" );
        dt_printDeviceTableOneLine( );
        wiced_hal_puart_print( "\n\r" );
    }
    else if( readbyte == 'm' )
    {
