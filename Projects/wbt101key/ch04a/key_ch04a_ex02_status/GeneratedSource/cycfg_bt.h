                ...
                <ProfileRole type="Server">
                    ...
                    <Services>
                        <Service type="org.bluetooth.service.generic_access">
                            <ServiceProperties>
                                <Property id="EntityID" value="{d69f73d0-4dc3-4799-b89b-c1cfa02b569b}"/>
                                    ...
                                    <Fields>
                                        <Field>
                                            <FieldProperties>
                                                ...
                                                <Property id="Value" value="key_status"/>
                        ...
                        <Service type="org.bluetooth.service.generic_attribute">
                            <ServiceProperties>
                                <Property id="EntityID" value="{44d0db7c-fcab-468d-b375-266e8b7364ea}"/>
                                <Property id="ServiceDeclaration" value="Primary"/>
                            </ServiceProperties>
                            <Characteristics/>
                        </Service>
