...
uint8_t BT_LOCAL_NAME[] = { 'k','e','y','_','S','p','p','M','u','l','t','i','b','o','n','d','\0' };
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    /* BLE Scan Settings */
    .ble_scan_cfg = {
        .scan_mode =                        BTM_BLE_SCAN_MODE_NONE,                                                 /**< BLE Scan Mode (BTM_BLE_SCAN_MODE_PASSIVE or BTM_BLE_SCAN_MODE_ACTIVE) */

        /* Advertisement Scan Configuration */
        .high_duty_scan_interval =          0x0000,                                                                 /**< High Duty Scan Interval */
        .high_duty_scan_window =            0x0000,                                                                 /**< High Duty Scan Window */
        .high_duty_scan_duration =          0,                                                                      /**< High Duty Scan Duration in seconds (0 for infinite) */

        .low_duty_scan_interval =           0x0000,                                                                 /**< Low Duty Scan Interval */
        .low_duty_scan_window =             0x0000,                                                                 /**< Low Duty Scan Window */
        .low_duty_scan_duration =           0,                                                                      /**< Low Duty Scan Duration in seconds (0 for infinite) */

        /* Connection Scan Configuration */
        .high_duty_conn_scan_interval =     0x0000,                                                                 /**< High Duty Connection Cycle Connection Scan Interval */
        .high_duty_conn_scan_window =       0x0000,                                                                 /**< High Duty Connection Cycle Connection Scan Window */
        .high_duty_conn_duration =          0,                                                                      /**< High Duty Connection Cycle Connection Duration in seconds (0 for infinite) */

        .low_duty_conn_scan_interval =      0x0000,                                                                 /**< Low Duty Connection Cycle Connection Scan Interval */
        .low_duty_conn_scan_window =        0x0000,                                                                 /**< Low Duty Connection Cycle Connection Scan Window */
    ...
    .ble_advert_cfg = {
        .channel_map =                      0,                                                                      /**< Advertising Channel Map (mask of BTM_BLE_ADVERT_CHNL_37, BTM_BLE_ADVERT_CHNL_38, BTM_BLE_ADVERT_CHNL_39) */

        .high_duty_min_interval =           0,                                                                      /**< High Duty Undirected Connectable Minimum Advertising Interval */
        .high_duty_max_interval =           0,                                                                      /**< High Duty Undirected Connectable Maximum Advertising Interval */
        .high_duty_duration =               0,                                                                      /**< High Duty Undirected Connectable Advertising Duration in seconds (0 for infinite) */

        .low_duty_min_interval =            0,                                                                      /**< Low Duty Undirected Connectable Minimum Advertising Interval */
        .low_duty_max_interval =            0,                                                                      /**< Low Duty Undirected Connectable Maximum Advertising Interval */
        .low_duty_duration =                0,                                                                      /**< Low Duty Undirected Connectable Advertising Duration in seconds (0 for infinite) */

        .high_duty_directed_min_interval =  0,                                                                      /**< High Duty Directed Minimum Advertising Interval */
        .high_duty_directed_max_interval =  0,                                                                      /**< High Duty Directed Maximum Advertising Interval */

        .low_duty_directed_min_interval =   0,                                                                      /**< Low Duty Directed Minimum Advertising Interval */
        .low_duty_directed_max_interval =   0,                                                                      /**< Low Duty Directed Maximum Advertising Interval */
        .low_duty_directed_duration =       0,                                                                      /**< Low Duty Directed Advertising Duration in seconds (0 for infinite) */

        .high_duty_nonconn_min_interval =   0,                                                                      /**< High Duty Non-Connectable Minimum Advertising Interval */
        .high_duty_nonconn_max_interval =   0,                                                                      /**< High Duty Non-Connectable Maximum Advertising Interval */
        .high_duty_nonconn_duration =       0,                                                                      /**< High Duty Non-Connectable Advertising Duration in seconds (0 for infinite) */

        .low_duty_nonconn_min_interval =    0,                                                                      /**< Low Duty Non-Connectable Minimum Advertising Interval */
        .low_duty_nonconn_max_interval =    0,                                                                      /**< Low Duty Non-Connectable Maximum Advertising Interval */
