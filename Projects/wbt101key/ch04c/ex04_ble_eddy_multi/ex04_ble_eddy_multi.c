 ...
 * Function Prototypes
 ******************************************************************/
static void                  ex04_ble_eddy_multi_app_init               ( void );
static wiced_bt_dev_status_t ex04_ble_eddy_multi_management_callback    ( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data );
static void                  ex04_ble_eddy_multi_set_advertisement_data_url ( void );
static void                  ex04_ble_eddy_multi_set_advertisement_data_uid ( void );
static void                  ex04_ble_eddy_multi_set_advertisement_data_tlm ( void );
static void                  ex04_ble_eddy_multi_advertisement_stopped  ( void );
static void                  ex04_ble_eddy_multi_reset_device           ( void );
static uint32_t              hci_control_process_rx_cmd          ( uint8_t* p_data, uint32_t len );
#ifdef HCI_TRACE_OVER_TRANSPORT
static void                  ex04_ble_eddy_multi_trace_callback         ( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data );
#endif
...
void application_start(void)
{
    ...
    wiced_bt_stack_init(ex04_ble_eddy_multi_management_callback, &wiced_bt_cfg_settings, wiced_bt_cfg_buf_pools);
}

/*
 * This function is executed in the BTM_ENABLED_EVT management callback.
 */
void ex04_ble_eddy_multi_app_init(void)
{
    ...
    ex04_ble_eddy_multi_set_advertisement_data_url();
    ex04_ble_eddy_multi_set_advertisement_data_uid();
...
void ex04_ble_eddy_multi_set_advertisement_data_url( void )
{
...
/* Set Advertisement Data for URL */
void ex04_ble_eddy_multi_set_advertisement_data_uid( void )
{
    uint8_t advPacket[31];
    uint8_t len = 0;
...
void ex04_ble_eddy_multi_set_advertisement_data_tlm( void )
{
    uint8_t advPacket[31];
    uint8_t len = 0;
...
void ex04_ble_eddy_multi_advertisement_stopped( void )
{
...
void ex04_ble_eddy_multi_reset_device( void )
{
...
wiced_bt_dev_status_t ex04_ble_eddy_multi_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENABLED_EVT:
        ...
        wiced_bt_dev_register_hci_trace(ex04_ble_eddy_multi_trace_callback);
#endif
...
#if 0
        if (ex04_ble_eddy_multi_read_link_keys( &p_event_data->paired_device_link_keys_request ))
        {
    ...
    case BTM_BLE_ADVERT_STATE_CHANGED_EVT:
        ...
        {
            ex04_ble_eddy_multi_advertisement_stopped();
        }
        break;
...
void ex04_ble_eddy_multi_trace_callback( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data )
{
...
{
    upTime += 1;
    ex04_ble_eddy_multi_set_advertisement_data_tlm();
}
