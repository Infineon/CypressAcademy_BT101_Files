...
static uint16_t ledHandle=0x2A;

/*******************************************************************
 * Function Prototypes
 ******************************************************************/
static void                  ex03_connect_app_init               ( void );
static wiced_bt_dev_status_t ex03_connect_management_callback    ( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data );
static void                  ex03_connect_reset_device           ( void );
static uint32_t              hci_control_process_rx_cmd          ( uint8_t* p_data, uint32_t len );
#ifdef HCI_TRACE_OVER_TRANSPORT
static void                  ex03_connect_trace_callback         ( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data );
#endif
...
void application_start(void)
{
    ...
    wiced_bt_stack_init(ex03_connect_management_callback, &wiced_bt_cfg_settings, wiced_bt_cfg_buf_pools);
}

/*
 * This function is executed in the BTM_ENABLED_EVT management callback.
 */
void ex03_connect_app_init(void)
{
...
void ex03_connect_reset_device( void )
{
...
wiced_bt_dev_status_t ex03_connect_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENABLED_EVT:
        ...
        wiced_bt_dev_register_hci_trace(ex03_connect_trace_callback);
#endif
...
#if 0
        if (ex03_connect_read_link_keys( &p_event_data->paired_device_link_keys_request ))
        {
...
void ex03_connect_trace_callback( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data )
{
...
void rx_cback( void *data )
{
    ...
    case 's':
        ...
        wiced_bt_ble_scan(BTM_BLE_SCAN_TYPE_HIGH_DUTY, WICED_FALSE, newAdvCallback);
        break;
    case 'S':
        WICED_BT_TRACE( "Scan Off\n\r" );
        wiced_bt_ble_scan(BTM_BLE_SCAN_TYPE_NONE, WICED_FALSE, newAdvCallback);
        break;
