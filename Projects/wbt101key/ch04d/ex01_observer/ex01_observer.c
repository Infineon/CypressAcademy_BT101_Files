 ...
 * Function Prototypes
 ******************************************************************/
static void                  ex01_observer_app_init               ( void );
static wiced_bt_dev_status_t ex01_observer_management_callback    ( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data );
static void                  ex01_observer_reset_device           ( void );
static uint32_t              hci_control_process_rx_cmd          ( uint8_t* p_data, uint32_t len );
#ifdef HCI_TRACE_OVER_TRANSPORT
static void                  ex01_observer_trace_callback         ( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data );
#endif
...
void application_start(void)
{
    ...
    wiced_bt_stack_init(ex01_observer_management_callback, &wiced_bt_cfg_settings, wiced_bt_cfg_buf_pools);
}

/*
 * This function is executed in the BTM_ENABLED_EVT management callback.
 */
void ex01_observer_app_init(void)
{
...
void ex01_observer_reset_device( void )
{
...
wiced_bt_dev_status_t ex01_observer_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENABLED_EVT:
        ...
        wiced_bt_dev_register_hci_trace(ex01_observer_trace_callback);
#endif
...
#if 0
        if (ex01_observer_read_link_keys( &p_event_data->paired_device_link_keys_request ))
        {
...
void ex01_observer_trace_callback( wiced_bt_hci_trace_type_t type, uint16_t length, uint8_t* p_data )
{
