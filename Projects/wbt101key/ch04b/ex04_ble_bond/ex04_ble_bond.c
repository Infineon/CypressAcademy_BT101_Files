...
uint8_t ex04_ble_bond_wiced101_button[]           =  {0x00};
uint8_t ex04_ble_bond_wiced101_button_cccd[]      =  {0x00,0x00};
...
gatt_db_lookup_table ex04_ble_bond_gatt_db_ext_attr_tbl[] =
{
    ...
    {HDLC_WICED101_BUTTON_VALUE,                 1,      1,      ex04_ble_bond_wiced101_button},
    {HDLD_WICED101_BUTTON_CLIENT_CONFIGURATION,  2,      2,      ex04_ble_bond_wiced101_button_cccd},
};
...
wiced_bt_dev_status_t ex04_ble_bond_management_callback( wiced_bt_management_evt_t event, wiced_bt_management_evt_data_t *p_event_data )
{
    ...
    case BTM_ENCRYPTION_STATUS_EVT:
        ...
        if(bond_mode == WICED_FALSE)
        {
            ...
            ex04_ble_bond_wiced101_button_cccd[0] = hostinfo.cccd;
...
wiced_bt_gatt_status_t ex04_ble_bond_connect_callback( wiced_bt_gatt_connection_status_t *p_conn_status )
{
    ...
    if ( NULL != p_conn_status )
    {
        ...
        else
        {
            ...
            ex04_ble_bond_wiced101_button_cccd[0] = 0;
...
void button_cback( void *data, uint8_t port_pin )
{
    ...
    ex04_ble_bond_wiced101_button[0] = !wiced_hal_gpio_get_pin_input_status( WICED_GPIO_PIN_BUTTON_1 );

    /* Send notification if there is a connection and notifications are enabled */
    if ( connection_id != 0)
    {
         if(ex04_ble_bond_wiced101_button_cccd[0] & GATT_CLIENT_CONFIG_NOTIFICATION)
        {
            wiced_bt_gatt_send_notification(connection_id, HDLC_WICED101_BUTTON_VALUE, sizeof(ex04_ble_bond_wiced101_button), ex04_ble_bond_wiced101_button );
