...
/* This name is used for BR/EDR (Classic) inquiry/discovery */
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    .ble_advert_cfg =                                               /* BLE advertisement settings */
    {
        ...
        .high_duty_duration              = 15,                                                         /**< High duty undirected connectable advertising duration in seconds (0 for infinite) */
        ...
        .low_duty_duration               = 15,                                                         /**< Low duty undirected connectable advertising duration in seconds (0 for infinite) */
