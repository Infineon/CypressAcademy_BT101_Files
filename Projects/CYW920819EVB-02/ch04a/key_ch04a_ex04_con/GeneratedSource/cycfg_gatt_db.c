...
const uint8_t gatt_database[] = 
{
    ...
    PRIMARY_SERVICE_UUID128 (HDLS_MODUS101, __UUID_SERVICE_MODUS101),
        ...
        CHARACTERISTIC_UUID128 (HDLC_MODUS101_BUTTON, HDLC_MODUS101_BUTTON_VALUE, __UUID_CHARACTERISTIC_MODUS101_BUTTON, LEGATTDB_CHAR_PROP_READ, LEGATTDB_PERM_READABLE),
};
...
uint8_t app_modus101_button[] = {0x00, };
...
gatt_db_lookup_table_t app_gatt_db_ext_attr_tbl[] =
{
    ...
    { HDLC_MODUS101_BUTTON_VALUE, 1,      1,      app_modus101_button },
};
...
const uint16_t app_modus101_button_len = (sizeof(app_modus101_button));
