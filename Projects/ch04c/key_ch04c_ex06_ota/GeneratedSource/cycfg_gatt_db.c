...
const uint8_t gatt_database[] = 
{
    ...
    PRIMARY_SERVICE_UUID128 (HDLS_BT101, __UUID_SERVICE_BT101),
        ...
        CHARACTERISTIC_UUID128 (HDLC_BT101_COUNTER, HDLC_BT101_COUNTER_VALUE, __UUID_CHARACTERISTIC_BT101_COUNTER, LEGATTDB_CHAR_PROP_READ | LEGATTDB_CHAR_PROP_NOTIFY, LEGATTDB_PERM_READABLE | LEGATTDB_PERM_AUTH_READABLE),
            /* Descriptor: Client Characteristic Configuration */
            CHAR_DESCRIPTOR_UUID16_WRITABLE (HDLD_BT101_COUNTER_CLIENT_CHAR_CONFIG, __UUID_DESCRIPTOR_CLIENT_CHARACTERISTIC_CONFIGURATION, LEGATTDB_PERM_READABLE | LEGATTDB_PERM_WRITE_REQ | LEGATTDB_PERM_AUTH_READABLE | LEGATTDB_PERM_AUTH_WRITABLE),
            /* Descriptor: Characteristic User Description */
            CHAR_DESCRIPTOR_UUID16 (HDLD_BT101_COUNTER_CHAR_USER_DESCRIPTION, __UUID_DESCRIPTOR_CHARACTERISTIC_USER_DESCRIPTION, LEGATTDB_PERM_READABLE),

    /* Primary Service: Custom OTA Firmware Upgrade */
    PRIMARY_SERVICE_UUID128 (HDLS_OTA_FW_UPGRADE_SERVICE, __UUID_SERVICE_CUSTOM_OTA_FIRMWARE_UPGRADE),
...
uint8_t app_bt101_counter[]                                           = {0x00, };
uint8_t app_bt101_counter_client_char_config[]                        = {0x00, 0x00, };
uint8_t app_bt101_counter_char_user_description[]                     = {'C', 'o', 'u', 'n', 't', ' ', 'o', 'f', ' ', 'b', 'u', 't', 't', 'o', 'n', ' ', 'p', 'r', 'e', 's', 's', 'e', 's', };
...
gatt_db_lookup_table_t app_gatt_db_ext_attr_tbl[] =
{
    ...
    { HDLC_BT101_COUNTER_VALUE,                                     1,      1,      app_bt101_counter },
    { HDLD_BT101_COUNTER_CLIENT_CHAR_CONFIG,                        2,      2,      app_bt101_counter_client_char_config },
    { HDLD_BT101_COUNTER_CHAR_USER_DESCRIPTION,                     23,     23,     app_bt101_counter_char_user_description },
...
const uint16_t app_bt101_counter_len = (sizeof(app_bt101_counter));
const uint16_t app_bt101_counter_client_char_config_len = (sizeof(app_bt101_counter_client_char_config));
const uint16_t app_bt101_counter_char_user_description_len = (sizeof(app_bt101_counter_char_user_description));
