...
void app_set_advertisement_data( void )
{
    ...
    uint8_t mfr_data[] = { 0x31, 0x01, 0x2A };
...
/*******************************************************************************
* Function Name: void app_scan_response_data( void )
********************************************************************************/
void app_set_scan_response_data( void )
{
    ...
    uint8_t service_uuid[] = {__UUID_SERVICE_MODUS};

    /* Advertisement Element for Flags */
    adv_elem[num_elem].advert_type = BTM_BLE_ADVERT_TYPE_128SRV_COMPLETE;
    adv_elem[num_elem].len = sizeof( service_uuid );
    adv_elem[num_elem].p_data = service_uuid;
    num_elem++;
