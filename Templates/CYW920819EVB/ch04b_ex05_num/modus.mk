...
CY_EXAMPLE_NAME = ch04b_ex05_num

CY_EXAMPLE_DESCRIPTION = Template for the CYW920819EVB-02 kit that demonstrates bonding with a passkey and can be extended to use numeric comparison authentication.\n\nREMEMBER to set BT_DEVICE_ADDRESS = random.\n\n
