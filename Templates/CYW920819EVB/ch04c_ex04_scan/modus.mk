...
CY_EXAMPLE_NAME = ch04c_ex04_scan

CY_EXAMPLE_DESCRIPTION = Template for the CYW920819EVB-02 kit that starts the Bluetooth stack, enables the GATT database, indicates the advertising state with a PWM driving the orange LED, and contains a completed callback interrupt for the black user button that notifies the central.\n\nREMEMBER to set BT_DEVICE_ADDRESS = random.\n\n
