...
CY_EXAMPLE_NAME = ch02_ex

CY_EXAMPLE_DESCRIPTION = Template for the CYW920819EVB-02 kit that starts the Bluetooth stack and creates an RTOS thread for user code to test peripherals like GPIO, UART, ADC and so on.
