...
// LED_1 and LED_2 are pre-configured, others are configurable via SuperMux
typedef enum
{
    WICED_PLATFORM_LED_1,  //!< LED 1 (WICED_P26)
    WICED_PLATFORM_LED_2,  //!< LED 2 (WICED_P28)
...
// BUTTON is pre-configured, others are configurable via SuperMux
typedef enum
{
    WICED_PLATFORM_BUTTON_1,  //!< BUTTON 1 (WICED_P00)
    WICED_PLATFORM_BUTTON_2,  //!< BUTTON 2 (WICED_P01)
...
/*! pins for buttons annd LEDs on the shield */
